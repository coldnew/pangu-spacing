...
(defvar pangu-spacing-timer nil)
...
(defmacro pangu-spacing-start-timer (func)
  `(setq pangu-spacing-timer (run-with-timer 1 1 ,func)))

(defun pangu-spacing-kill-timer ()
  (cancel-timer pangu-spacing-timer))
